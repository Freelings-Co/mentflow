...
const MentFlowLanding = () => {
    ...
    const steps = [
        {
            ...
            description: "Conte sua história e preferências para encontrarmos o terapeuta ideal para você."
        },
        {
            number: 2,
            title: "Match Inteligente",
            description: "Nossa plataforma conecta você ao profissional que melhor se alinha com suas necessidades."
        },
        {
            number: 3,
            title: "Sessões Flexíveis",
            description: "Agende sessões no horário que funciona para você, com total flexibilidade."
        }
    ];
    ...
    const services = [
        {
            ...
            description: "Sessões personalizadas focadas no seu desenvolvimento pessoal e bem-estar emocional.",
            features: ["Sessões 1:1", "Plano personalizado", "Acompanhamento contínuo"]
        },
        {
            icon: Video,
            title: "Terapia Online",
            description: "Atendimento por videochamada com a mesma qualidade da terapia presencial.",
            features: ["Plataforma segura", "Gravação opcional", "Qualidade HD"]
        },
        {
            icon: Users,
            title: "Terapia em Grupo",
            description: "Sessões em grupo para compartilhar experiências e crescer junto com outros.",
    ...
    const testimonials = [
        {
            content: "A MentFlow mudou minha vida. Encontrei uma terapeuta incrível que realmente me entende.",
            author: "Maria Silva",
            role: "Designer",
            avatar: "https://images.unsplash.com/photo-1494790108755-2616b612b790?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80"
        },
        {
            content: "Flexibilidade total para agendar as sessões. Perfeito para minha rotina corrida.",
            author: "João Santos",
            role: "Empresário",
            avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80"
        },
        {
            content: "Atendimento de qualidade internacional, mesmo morando fora do Brasil.",
            author: "Ana Costa",
            role: "Estudante",
